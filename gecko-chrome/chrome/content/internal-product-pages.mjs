...
export function renderAdditionalProductPage(page, t, escape) {
  ...
  if (page.key === "credits") {
    return `<section class="card"><h2>Navis</h2><p>${escape(t("settings.aboutCopyright"))}</p><p>${escape(t("credits.notice"))}</p><p><a href="https://www.mozilla.org/MPL/2.0/" target="_blank" rel="noopener noreferrer">Mozilla Public License 2.0</a></p><h2>uBlock Origin</h2><p>Copyright Raymond Hill and contributors · GPL-3.0-or-later</p><p><a href="https://github.com/gorhill/uBlock/tree/6dd2d95e50d134a477a4e183343c0b26e9147123" target="_blank" rel="noopener noreferrer">uBlock Origin</a></p></section><section class="card"><h2>${escape(t("credits.packagedNotices"))}</h2><pre id="credits-notices" class="credits-notices"></pre><p id="management-status" class="management-status" role="status" aria-live="polite">${escape(t("management.loading"))}</p></section>`;
  }
  return null;
}
